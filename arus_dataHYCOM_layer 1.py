...
lat = -6.246066     # Lintang lokasi
lon = 107.915292   # Bujur lokasi
...
surface_depth = ds['depth'][0]  # Memilih kedalaman pertama (permukaan)
...
print("Data berhasil disimpan ke 'data_arus_1.txt'")
