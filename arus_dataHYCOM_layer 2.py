...
lat = -6.239164     # Lintang lokasi
lon = 107.919326  # Bujur lokasi
...
surface_depth = ds['depth'][1]  # Memilih kedalaman pertama (permukaan)
...
print("Data berhasil disimpan ke 'data_arus_2.txt'")
